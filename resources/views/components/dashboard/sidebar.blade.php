<div class="container ml-3">
    ...
    <div class="d-flex flex-column">
        <label class="samazon-sidebar-category-label">
           <a href="/samazooon/dashboard/products">商品一覧</a>
        </label>
        <label class="samazon-sidebar-category-label">
           <a href="/samazooon/dashboard/major_categories">親カテゴリ管理</a>
        </label>
        <label class="samazon-sidebar-category-label">
           <a href="/samazooon/dashboard/categories">カテゴリ管理</a>
        </label>
    ...
    <div class="d-flex flex-column">
       <label class="samazon-sidebar-category-label">
           <a href="/samazooon/dashboard/users">顧客一覧</a>
       </label>
